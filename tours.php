...
<div class="container py-5">
  ...
  <div class="image-wrapper position-relative">
      <img src="images/121279625_990276098117910_4237845109015976041_n.jpg" class="card-img-top" alt="Hotels in Tanzania" style="max-height: 400px; object-fit: cover;">
...
<div class="form-modal" id="tourModal">
  ...
  <input type="tel" class="form-control" name="phone" required>
      ...
      <div class="mb-3">
        <label for="destination" class="form-label" style="font-weight: bold">Select Destination</label>
      ...
      <div class="row mb-3">
        <div class="col-md-6">
          <label for="start_date" class="form-label" style="font-weight: bold">Start Date</label>
          <input type="date" class="form-control" name="start_date" required>
        </div>
        <div class="col-md-6">
          <label for="end_date" class="form-label" style="font-weight: bold">End Date</label>
          <input type="date" class="form-control" name="end_date" required>
        </div>
      </div>

      <div class="mb-3">
        <label for="group_size" class="form-label" style="font-weight: bold">Number of Travelers</label>
        <input type="number" class="form-control" name="group_size" min="1" required>
      </div>

      <div class="mb-3">
        <label for="requests" class="form-label" style="font-weight: bold">Special Requests (Optional)</label>
